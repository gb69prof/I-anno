const CACHE='civilta-fluviali-v5';
const ASSETS=['./','./index.html','./style.css','./app.js','./manifest.webmanifest','./assets/icon.svg','./assets/cartina-civilta-fluviali.webp','./assets/cartina-oggi-civ-fluviali.webp','./assets/cartina-mesopotamia.webp','./assets/cartina-egitto.webp'];
