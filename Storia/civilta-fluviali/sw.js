const CACHE='civilta-fluviali-v4';
const ASSETS=['./','./index.html','./style.css','./app.js','./manifest.webmanifest','./assets/icon.svg','./assets/map-mesopotamia.svg','./assets/map-egitto.svg'];
